              ...
              */}
              ...
              <foreignObject x="20" y="110" width="140" height="190">
                <div className="w-full h-full">
                  <div className="w-full h-full border border-base-content/20 bg-black/60 rounded-lg p-2.5 flex flex-col font-mono text-[11px] text-slate-300 leading-normal select-text">
                    ...
                    <div className="flex-1 min-h-0 overflow-y-auto overflow-x-hidden whitespace-normal break-all scrollbar-thin flex flex-col gap-2 text-[13px] leading-relaxed">
              ...
              <foreignObject x="1000" y="110" width="160" height="190">
                <div className="w-full h-full fixed">
                  <div className={`w-full h-full border rounded-lg p-2.5 flex flex-col font-mono text-[11px] leading-normal select-text ${
                    stageStatuses[5] === 'warning'
                    ...
                    <div className="flex-1 min-h-0 overflow-y-auto overflow-x-hidden whitespace-normal break-all scrollbar-thin flex flex-col gap-2 text-[13px] leading-relaxed">
                      {egressGuardrailResponse ? (
                        <span className="font-bold text-slate-100">{egressGuardrailResponse}</span>
                        ...
                        <span className="italic text-slate-600 select-none text-[13px]">[Buffering response...]</span>
                      ) : (
