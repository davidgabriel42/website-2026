          ...
          <div className="flex-1 bg-base-300/40 flex items-center justify-center p-3 relative overflow-hidden">
            <svg viewBox="0 0 1200 320" className="w-full h-auto max-h-[260px] pointer-events-auto overflow-visible mb-16">
              ...
              */}
              <path 
                d="M 160 55 L 216 55" 
                stroke={currentStage === 1 ? '#3b82f6' : stageStatuses[0] === 'passed' ? '#10b981' : '#2B3548'} 
                strokeWidth={currentStage === 1 ? '3.5' : '2.5'} 
                className={currentStage === 1 ? 'stroke-dash' : ''} 
                marker-end={currentStage === 1 ? "url(#arrow-blue)" : stageStatuses[0] === 'passed' ? "url(#arrow-green)" : "url(#arrow-dark)"}
              />
              <path 
                d="M 356 55 L 412 55" 
              ...
              <path 
                d="M 552 55 L 608 55" 
                stroke={currentStage === 4 || currentStage === 7 ? '#3b82f6' : stageStatuses[2] === 'passed' ? '#10b981' : '#2B3548'} 
                strokeWidth={currentStage === 4 || currentStage === 7 ? '3.5' : '2.5'} 
                className={currentStage === 4 || currentStage === 7 ? 'stroke-dash' : ''} 
                marker-end={currentStage === 4 || currentStage === 7 ? "url(#arrow-blue)" : stageStatuses[2] === 'passed' ? "url(#arrow-green)" : "url(#arrow-dark)"}
              />
              <path 
                d="M 748 55 L 804 55" 
